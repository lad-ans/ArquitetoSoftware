...
namespace NerdStore.Vendas.Domain.Tests
{
    public class PedidoTests
    {
        ...
        public void AdicionarItemPedido_NovoPedido_DeveAtualizarValor()
        {
            ...
            var pedidoItem = new PedidoItem(Guid.NewGuid(), "Poduto Teste", 2, 100);
        ...
        [Trait("Categoria", "Vendas - Pedido")]
        public void AdicionarItemPedido_ItemExistente_DeveIncrementarUnidadeSomarValore()
        {
            // Arrange
            var pedido = Pedido.PedidoFactory.NovoPedidoRascunho(Guid.NewGuid());
            var produtoId = Guid.NewGuid();
            var pedidoItem = new PedidoItem(produtoId, "Poduto Teste", 2, 100);
            pedido.AdicionarItem(pedidoItem);
        ...
        [Fact(DisplayName = "Atualizar Item Pedido")]
        [Trait("Categoria", "Vendas - Pedido")]
        public void AtualizarItemPedido_ItemValido_DeveAtualizarQuantidade()
        {
            ...
            // Assert
            Assert.Equal(novaQuantidade, pedido.PedidoItems.FirstOrDefault(p => p.ProdutoId == pedidoItemAtualizado.ProdutoId).Quantidade);
        }
        ...
        public void AplicarVoucher_VoucherTipoPercentualDesconto_DeveDescontarDoValorTotal()
        {
            ...
            var voucher = new Voucher("PROMO-15-OFF", 15, null, 1,
                TipoDescontoVoucher.Percentagem, DateTime.Now.AddDays(10), true, false);
