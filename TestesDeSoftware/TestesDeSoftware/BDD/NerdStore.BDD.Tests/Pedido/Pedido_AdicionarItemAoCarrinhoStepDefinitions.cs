...
public class Pedido_AdicionarItemAoCarrinhoStepDefinitions
{
    ...
    {
        // Arrange 
        _pedidoTela.ClicarAdicionarQuantidadeItens(Pedido.MAX_UNIDADES_ITEM + 1);
    ...
    public void EntaoReceberaUmaMensagemDeErroMencionandoQueFoiUltrapassadaAQuantidadeLimite()
    {
        ...
        // Assert
        Assert.Contains($"A quantidade máxima de um item é {Pedido.MAX_UNIDADES_ITEM}", mensagem);
    }
    ...
    {
        // Arrange 
        _pedidoTela.ClicarAdicionarQuantidadeItens(Pedido.MAX_UNIDADES_ITEM);
